...
contextBridge.exposeInMainWorld('shelf', {
  ...
  homekitDiscover: () => ipcRenderer.invoke('homekit-discover'),
  homekitPair: (data) => ipcRenderer.invoke('homekit-pair', data),
  homekitAccessories: () => ipcRenderer.invoke('homekit-accessories'),
  homekitControl: (data) => ipcRenderer.invoke('homekit-control', data),
  homekitUnpair: (deviceId) => ipcRenderer.invoke('homekit-unpair', deviceId),
  homekitPairedDevices: () => ipcRenderer.invoke('homekit-paired-devices'),
  haGetStates: (entityIds) => ipcRenderer.invoke('ha-get-states', entityIds),
  haCallService: (data) => ipcRenderer.invoke('ha-call-service', data),
  haGetEntities: () => ipcRenderer.invoke('ha-get-entities'),
